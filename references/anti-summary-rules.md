...
The single most common failure mode for this skill is writing summaries instead of manuscripts. Read this before every writing session.

## You MUST NOT

- Write skeleton sections with headings and brief notes
- Produce bullet-point outlines disguised as prose
- Write "the results show good performance" without specific cached values
- Write "the model achieved high accuracy" without giving the actual R² / RMSE / metric
- Stop mid-section and say "more detail can be added"
- Use phrases like "This section will cover...", "In summary, the model...", "As discussed above..."
- Invent numbers when the cached files do not contain what you need — report the gap to the user instead
- Write placeholder sentences that a reviewer would flag as empty

## You MUST

- Write complete, coherent paragraphs that build a scientific argument across sentences
